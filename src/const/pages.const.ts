		...
		children: [
			{
				...
				title: 'Rectangle Page Transition',
				description: `On this page, you will find rectangle page transition example, done with Framer 
			...
			},
			{
				...
				title: 'Clip Path Page Transition',
